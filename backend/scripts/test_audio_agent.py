...
def test_detect_deception_markers():
    ...
    task = {
        ...
        "params": {
            ...
            "focus": "financial statements and liability reporting"
        }
    }
...
def test_analyze_transcript_content():
    ...
    task = {
        ...
        "params": {
            "company": "Wipro",
            "topic": "financial health, cash flows, and operational efficiency"
        }
    }
...
def test_analyze_itc():
    ...
    task = {
        ...
        "params": {
            "company": "ITC Limited",
            "topic": "business portfolio, debt position, and cash flow stability"
        }
    }
